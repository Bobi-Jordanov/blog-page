...
//fetch users form database, but not the current user
...
?>
        ...
        <section class="dashboard">
            ...
            <!-- displaying if there had been any error -->
            ...
            <!-- show if a user has been deleted -->
            ...
            <!-- show if a delete-user wasn't successful -->
